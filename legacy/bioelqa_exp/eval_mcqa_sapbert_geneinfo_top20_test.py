...
GOLD = "bioelqa_test_mcqa_gold_sapbert_geneinfo_top20.tsv"
PRED = "bioelqa_test_mcqa_predictions_qwen14_sapbert_geneinfo_top20.txt"
...
with open(PRED, encoding="utf-8") as f:
    for line in f:
        ...
        # accept formats like:
        # test_sapbert_case_1 Answer: M
        # test_sapbert_case_1 M

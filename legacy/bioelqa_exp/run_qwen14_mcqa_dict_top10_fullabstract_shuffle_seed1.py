...
INPUT = Path("bioelqa_dev_mcqa_prompts_dict_top10_fullabstract_shuffle_seed1.jsonl")
OUTPUT = Path("bioelqa_dev_mcqa_predictions_qwen14_dict_top10_fullabstract_shuffle_seed1.txt")

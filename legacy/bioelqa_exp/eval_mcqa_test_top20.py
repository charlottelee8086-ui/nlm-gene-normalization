...
GOLD = "bioelqa_test_mcqa_gold_top20.tsv"
PRED = "bioelqa_test_mcqa_predictions_qwen14_top20.txt"
...
with open(PRED, encoding="utf-8") as f:
    for line in f:
        m_case = re.search(r"(test_mcqa_case_\d+)", line)
...
print("=== Dictionary Top-20 TEST Evaluation ===")

...
GOLD = "bioelqa_dev_mcqa_gold_top15_fullabstract.tsv"
PRED = "bioelqa_dev_mcqa_predictions_qwen14_top15_fullabstract.txt"
...
print("=== Dictionary Top-15 + Full Abstract DEV Evaluation ===")

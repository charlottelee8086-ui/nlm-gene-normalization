...
INP = "bioelqa_dev_candidates_sapbert_geneinfo_top20.tsv"
OUT_PROMPTS = "bioelqa_dev_mcqa_prompts_sapbert_geneinfo_top20.jsonl"
OUT_GOLD = "bioelqa_dev_mcqa_gold_sapbert_geneinfo_top20.tsv"
...
with open(OUT_PROMPTS, "w", encoding="utf-8") as f_prompt, \
    ...
    for _, r in df.iterrows():
        case_id = f"dev_sapbert_case_{n + 1}"
